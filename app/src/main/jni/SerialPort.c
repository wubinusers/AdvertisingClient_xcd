...
JNIEXPORT jobject JNICALL Java_com_worldchip_advertising_client_utils_SerialPort_open(JNIEnv *env,
...
JNIEXPORT void JNICALL Java_com_worldchip_advertising_client_utils_SerialPort_close
